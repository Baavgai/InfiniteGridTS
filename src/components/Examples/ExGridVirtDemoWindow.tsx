...
interface Controller {
  ...
  // registerGrid: (loaderProps: InfiniteLoaderChildProps) => (grid: Grid | null) => void;
  onSectionRendered: (loaderProps: InfiniteLoaderChildProps) => (p: SectionRenderedParams) => any;
  // registerInifinteLoader: (p: InfiniteLoaderChildProps) => void;
}
...
const DemoView = (p: Props) =>
  ...
  >
    {loaderProps => {
      ...
      // p.registerInifinteLoader(loaderProps);
      // <AutoSizer disableHeight onResize={p.onResize}></AutoSizer>
      // ref={p.registerGrid(loaderProps)}
      return (
        <WindowScroller>
          {({ height, scrollTop }) => {
            ...
            return <AutoSizer disableHeight>
              {({ width }) => {
                console.log({ height, scrollTop, width, cache: p.cache });
                return <Grid
                  autoHeight
                  width={width}
                  height={height}
